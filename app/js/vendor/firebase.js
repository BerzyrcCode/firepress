(function() {
    ...
    function Lb(a) {
        ...
        sb(a, a.xc);
        for (d = c = 0; 5 > d; d++)
            for (var e = 24; 0 <= e; e -= 8) b[c] = a.C[d] >> e & 255, ++c;
        return Jb(b)
    }
            ...
            if (!c.Ma) {
                c.ma = new Qc(function(a, b, d, k, l) {
                    ...
                    if (c.ma)
                        ...
                        else if ("close" === a) b ? (c.ma.oc = !1, Kc(c.od, b, function() {
                        c.Oa()
                    })) : c.Oa();
    ...
    function bd(a, b) {
        return function(c) {
            if (2 != a.na)
                ...
                if (d = Xb("t", c), c = Xb("d", c), "c" == d) "t" in c && (c = c.t, "a" === c ? jd(a) : "r" === c ? (a.e("Got a reset on secondary, closing it"), a.w.close(), a.Ob !== a.w && a.Lb !== a.w || a.close()) : "o" === c && (a.e("got pong on secondary."),
                    a.wd--, jd(a)));
    ...
    function ld(a, b, c, d, e, f) {
        ...
        nd(this, 0);
        tc.rb().fb("visible", this.Vd, this); - 1 === a.host.indexOf("fblocal") && uc.rb().fb("online", this.Ud, this)
    }
    var md = 0,
        od = 0;
    h = ld.prototype;
    ...
    h.pd = function() {
        ...
        if (this.Ra) this.lb ? this.vb && (3E4 < (new Date).getTime() - this.vb && (this.ua = 1E3), this.vb = null) : (this.e("Window isn't visible.  Delaying reconnect."), this.ua = this.Xb, this.Kc = (new Date).getTime()), a = Math.max(0, this.ua - ((new Date).getTime() - this.Kc)), a *= Math.random(), this.e("Trying to reconnect in " +
            a + "ms"), nd(this, a), this.ua = Math.min(this.Xb, 1.3 * this.ua);
        else
    ...
    function be(a, b, c, d, e) {
        ...
        for (H = Ya(V); null !== G || null !== H;) {
            ...
            if (0 > c) f = va(t, G.key), n(f) ? (m.push({
                Fc: G,
                $c: k[f]
            }), k[f] = null) : (s[G.key] = l.length, l.push(G)), f = !0, G = Ya(w);
            else {
        ...
        for (g = 0; g < l.length; g++)
            if (t = l[g]) c = b.G(t.key), ae(a, c, t.value, M), e.push(new U("child_removed", t.value, t.key));
        for (g = 0; g < k.length; g++)
            if (t = k[g]) c = b.G(t.key), l = d.ga(t.key, t.value), ae(a, c, M, t.value), e.push(new U("child_added", t.value, t.key, l));
    ...
    function ye(a, b, c, d) {
        ...
        null !== f ? fe(f) ? e.push({
            path: b,
            ta: c
        }) : e = e.concat(we(a, f, g, c, d)) : e = e.concat(xe(a, c, g, d));
        return e
    }
    ...
    function Ue(a) {
        var b = a.j();
        if (null !== b) {
            for (var c = [], d = -1, e = 0; e < b.length; e++) 4 !== b[e].status && (2 === b[e].status ? (v(d === e - 1, "All SENT items should be at beginning of queue."), d = e, b[e].status = 4, b[e].uc = "set") : (v(1 === b[e].status), b[e].tc(), b[e].D && c.push(r(b[e].D, null, Error("set"), !1, null)))); - 1 === d ? J(a, null) : b.length = d + 1;
